...
export type AuthWhereInput = {
  ...
  role?: Prisma.EnumuserRolesFilter<"Auth"> | $Enums.userRoles
...
export type AuthScalarWhereWithAggregatesInput = {
  ...
  role?: Prisma.EnumuserRolesWithAggregatesFilter<"Auth"> | $Enums.userRoles
...
export type AuthOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "isEmailVerified" | "role" | "status" | "email" | "password" | "createdAt" | "updatedAt", ExtArgs["result"]["auth"]>
...
export interface AuthFieldRefs {
  ...
  readonly role: Prisma.FieldRef<"Auth", 'userRoles'>
